...
namespace Temporalio.Bridge
{
    ...
    internal class Client : SafeHandle
    {
        ...
        {
            Runtime = runtime;
            HandleRef = SafeHandleReference<ClientSafeHandle>.Owned(new ClientSafeHandle(ptr));
        }

        /// <inheritdoc />
        public override unsafe bool IsInvalid => HandleRef.Handle.IsInvalid;
        ...
        /// </summary>
        internal SafeHandleReference<ClientSafeHandle> HandleRef { get; private init; }
