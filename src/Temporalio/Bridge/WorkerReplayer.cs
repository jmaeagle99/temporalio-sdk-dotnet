...
namespace Temporalio.Bridge
{
    ...
    internal class WorkerReplayer : SafeHandle
    {
            ...
            : base(IntPtr.Zero, true)
        {
            ...
            using (var scope = new Scope())
            {
                unsafe
                {
                    ...
                    WorkerHandleRef = SafeHandleReference<WorkerSafeHandle>.Owned(new WorkerSafeHandle(replayerOrFail.worker));
                    Worker = new(runtime, WorkerHandleRef.Handle);
        ...
        /// <summary>
        /// Gets the worker handle reference.
        /// </summary>
        internal SafeHandleReference<WorkerSafeHandle> WorkerHandleRef { get; private init; }
