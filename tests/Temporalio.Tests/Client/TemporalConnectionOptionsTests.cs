...
public unsafe class TemporalConnectionOptionsTests
{
    ...
    public void ToInteropOptions_Metadata_Some()
    {
        ...
        AssertKeyValue(data[0], "key1", "client-ascii", scope);
        AssertKeyValue(data[1], "x-key1", "client-ascii-more", scope);
    }
    ...
    public void ToInteropOptions_RpcBinaryMetadata_Some()
    {
        ...
        AssertKeyValue(data[0], "key1-bin", "client-binary", scope);
        AssertKeyValue(data[1], "x-key1-bin", "client-binary-more", scope);
    }

    private static void AssertKeyValue(Bridge.Interop.TemporalCoreByteArrayRef byteArrayRef, string expectedKey, string expectedValue, Scope scope)
    {
